...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11612" data-batch-id="44" data-toggle="modal" data-target="#task-11612-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11614" data-batch-id="44" data-toggle="modal" data-target="#task-11614-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11618" data-batch-id="44" data-toggle="modal" data-target="#task-11618-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11620" data-batch-id="44" data-toggle="modal" data-target="#task-11620-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11622" data-batch-id="44" data-toggle="modal" data-target="#task-11622-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11623" data-batch-id="44" data-toggle="modal" data-target="#task-11623-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11623-users-done-modal" data-task-id="11623" data-batch-id="44">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Learners who are done with "11. More involved type annotations"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11623}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11624" data-batch-id="44" data-toggle="modal" data-target="#task-11624-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11624-users-done-modal" data-task-id="11624" data-batch-id="44">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Learners who are done with "12. Type Checking"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11624}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
        ...
        <div class="fs-4">
          ...
          <div class="modal fade" id="container-specs-modal"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">Recommended Sandbox</h4></div><div class="modal-body"><div data-react-class="user_containers/ContainerSpecs" data-react-props="{&quot;containerModelName&quot;:&quot;Sandbox&quot;,&quot;containerSpecs&quot;:[{&quot;description&quot;:&quot;\u003cp\u003eUbuntu 18.04 with Python 3.7\u003c/p\u003e\n&quot;,&quot;id&quot;:23,&quot;name&quot;:&quot;Ubuntu 18.04 - Python 3.7&quot;,&quot;online&quot;:true}],&quot;containersLimit&quot;:2,&quot;csrfToken&quot;:&quot;CXaTIpzG731BfwXQid14XkV71aVfpRp-ypK7DnLH2vKWi-JW-TEj6syD6Zysa94XD-P3xnerQE-1mw8z9W-q2w&quot;,&quot;startStatusURI&quot;:&quot;/user_containers/start_status.json&quot;,&quot;startURI&quot;:&quot;/user_containers/start.json&quot;}" data-react-cache-id="user_containers/ContainerSpecs-0"></div></div></div></div></div>
